...
//const DATA_URL = 'localhost/cdeuoervsrepmlocaofr4320bc0p-main/index.php';
//const DATA_URL = '192.168.0.132';
// const DATA_URL = '192.168.0.132/cdeuoervsrepmlocaofr4320bc0p-main/';
// const DATA_URL1 = '192.168.0.132';
// const DATA_URL2 = 'localhost/cdeuoervsrepmlocaofr4320bc0p-main/';
// const DATA_URL3 = 'localhost/cdeuoervsrepmlocaofr4320bc0p-main/index.php';
// const DATA_URL4 = '192.168.0.132/cdeuoervsrepmlocaofr4320bc0p-main/';
// const DATA_URL5 = '192.168.0.132/cdeuoervsrepmlocaofr4320bc0p-main/index.php';
...
const SQL_SELECT_ALL = 'SELECT * FROM `trip` LEFT OUTER JOIN `expense` ON trip.id = expense.id ORDER BY `nameOfTrip` ASC';
...
function searchFunction() {
    let input, filter, list, cards, headers, i, txtHeaders, txtDate, txtDestinations;
    ...
    Zepto(function($){
        ...
        db = window.sqlitePlugin.openDatabase(
           ...
           function (database) { //SUCCESS CALLBACK
                ...
                // $.ajax({
                //     url: 'allow-insecure-localhost/cdeuoervsrepmlocaofr4320bc0p-main/',
                //     type: 'POST',
...
// const url = "localhost/cdeuoervsrepmlocaofr4320bc0p-main/index.php";
// // const url = "http://localhost/phpmyadmin/index.php?route=/";
// const jsonPayload = {
//   "jsonpayload":{
//     "uid": "001132356",
//     "trips": [
...
//   success: function(data) {
//     console.log("Ajax POST request succeeded!");
//     console.log(data);
//   },
//   error: function(jqXHR, textStatus, errorThrown) {
...
let payload = {
  ...
  $.ajax({
    type: "POST",
    url: "localhost/bcomp3402/index.php",
    contentType: "application/json",
